...
#允许远程访问
#   Subline 打开 d:\redis\redis.windows.conf
#       注释 bind 127.0.0.1
...
#                           输入名称和描述点击完成
#   其他电脑远程访问本地redis
#           redis-cli -h 192.168.0.106 -p 6379    #-h后必须空格 -p后必须空格
#数据操作
...
#                   $ :q 退出vim
#       强制拉取远程仓库内容覆盖本地库
#           git fetch --all && git reset --hard origin/yilong && git pull
#       推送本地库内容到远程库
#           git push origin 分支名
